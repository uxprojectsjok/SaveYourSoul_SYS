...
TWILIO_WEBHOOK=https://YOUR_SERVICE.twil.io/whatsapp
...
```
functions
  public /whatsapp  https://YOUR_SERVICE.twil.io/whatsapp
```
...
`YOUR_SERVICE.twil.io` · Service SID: `ZS_YOUR_SERVICE_SID`
