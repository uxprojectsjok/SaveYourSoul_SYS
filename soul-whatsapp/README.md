...
TWILIO_WEBHOOK=https://YOUR_PROJECT-dev.twil.io/whatsapp
...
```
functions
  public /whatsapp  https://YOUR_PROJECT-dev.twil.io/whatsapp
```
...
`YOUR_PROJECT-dev.twil.io` · Service SID: `YOUR_SERVICE_SID`
