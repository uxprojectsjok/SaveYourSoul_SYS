          ...
          <header class="anc-head">
            <div class="anc-head-left">
              ...
              <div>
                ...
                <h2 class="anc-title">Soul verankern</h2>
              </div>
            </div>
            <button class="anc-close" @click="handleClose" aria-label="Schließen">✕</button>
          </header>
...
.anc-head-left { display: flex; align-items: center; gap: 14px; }
.anc-icon {
...
.anc-icon svg { width: 16px; height: 16px; }
.anc-kicker { font-family: var(--mono); font-size: 9px; letter-spacing: 0.22em; text-transform: uppercase; color: var(--fg-3); margin-bottom: 3px; }
.anc-title  { font-family: var(--serif); font-size: 18px; font-weight: 400; letter-spacing: -0.015em; color: var(--fg); line-height: 1.1; }
.anc-close  {
...
.anc-close:hover { color: var(--fg); border-color: var(--rule-2); }
...
.sheet-enter-active .anc-panel, .sheet-leave-active .anc-panel { transition: transform 0.2s cubic-bezier(0.34,1.56,0.64,1), opacity 0.2s ease; }
.sheet-enter-from, .sheet-leave-to { opacity: 0; }
.sheet-enter-from .anc-panel, .sheet-leave-to .anc-panel { transform: scale(0.96); opacity: 0; }
