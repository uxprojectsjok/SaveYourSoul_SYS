          ...
          <div class="divide-y divide-white/[0.05] rounded-xl border border-white/[0.07]">
            <div v-for="name in files" :key="name" class="flex items-center gap-2 px-3 min-h-[44px]">
              ...
              <button
                ...
                class="w-8 h-8 flex items-center justify-center rounded-lg transition disabled:opacity-25 shrink-0 text-white/25 hover:text-red-400 hover:bg-red-950/30"
