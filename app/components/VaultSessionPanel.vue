      ...
      <div v-if="open || headless" class="px-5 pb-5 space-y-4 border-t border-[var(--sys-border)]">
        ...
        <div v-if="isUnlocked || locking" class="space-y-3">
          ...
          >
            ...
            <button
              class="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-[rgba(239,68,68,0.3)] text-red-400 hover:bg-[rgba(239,68,68,0.1)] transition-colors min-h-[36px]"
              :disabled="locking"
              @click="handleLock"
