<template>
  <div class="legal-body space-y-8 text-[var(--sys-fg)] leading-relaxed max-w-prose">
    ...
    <div>
      <h1 class="text-2xl font-bold mb-2">Datenschutzerklärung</h1>
    ...
    <div class="p-4 rounded-xl border border-[rgba(255,200,0,0.25)] bg-[rgba(255,200,0,0.04)]">
      <p class="text-xs font-semibold text-[var(--sys-amber)] mb-1">Entwicklungsprojekt – Nicht im öffentlichen Betrieb</p>
    ...
    <section>
      ...
      <div class="space-y-2 text-sm text-[var(--sys-fg-muted)]">
        <div class="flex gap-3">
          ...
          <span>Art. 15 DSGVO — Auskunft über gespeicherte Daten</span>
        </div>
        <div class="flex gap-3">
          <span class="font-medium text-[var(--sys-fg)] w-36 flex-none">Berichtigung</span>
    ...
    <section>
      <h2 class="text-sm font-semibold text-[var(--sys-fg)] mb-3">14. Besonderheit: Invite-only</h2>
      <p class="text-base text-[var(--sys-fg-muted)]">SaveYourSoul läuft unter Realbedingungen und ist ausschließlich für eingeladene Nutzer zugänglich. Die Erstellung neuer Souls ist auf eingeladene Nutzer beschränkt. Die Nutzung erfolgt auf eigene Verantwortung.</p>
    </section>

    <p class="text-xs text-[var(--sys-fg-dim)] pt-4 border-t border-[var(--sys-border)]">Stand: 06. April 2026</p>
