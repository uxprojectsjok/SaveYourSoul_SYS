<template>
  <div class="legal-body space-y-8 text-[var(--sys-fg)] leading-relaxed max-w-prose">
    ...
    <section>
      ...
      <p class="text-base text-[var(--sys-fg-muted)]">SaveYourSoul ist eine geschlossene Anwendung von UX-Projects YOUR_NAME und läuft unter Realbedingungen. Der Zugang ist auf interne Nutzerinnen und Nutzer beschränkt; es findet kein öffentlicher Betrieb statt. Die Nutzung erfolgt auf eigene Verantwortung.</p>
    </section>

    <p class="text-xs text-[var(--sys-fg-dim)] pt-4 border-t border-[var(--sys-border)]">Stand: 17. April 2026</p>
