          ...
          <div class="w-full flex items-center gap-2 px-3 py-2.5">
            ...
            >
              ...
              <span class="text-xs font-medium truncate transition-colors"
                :class="section.agent
                  ? 'text-[#e53e3e]'
                  : openedSections[section.key] ? 'text-[var(--sys-fg)]' : 'text-[var(--sys-fg-muted)]'">
                {{ section.label }}
              </span>
...
import { parseSoul, updateSection, getAgentSection, setAgentSection } from "#shared/utils/soulParser.js";
...
const AGENT_SECTION_KEY = "__agent__";
...
const SOUL_SECTIONS = [
  ...
  { key: AGENT_SECTION_KEY,                      label: "Agent-Kontext",          icon: "ri-robot-line",     color: "var(--sys-orange)", agent: true },
];
