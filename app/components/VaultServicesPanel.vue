        ...
        <div class="px-5 pb-5 pt-4 border-t border-[var(--sys-border)] space-y-3">
          ...
          <div class="grid grid-cols-4 gap-1.5">
            <button
              ...
              :key="opt.value"
              class="py-2 rounded-lg border text-xs font-mono transition-all min-h-[32px]"
          ...
          <button
            class="w-full py-3 rounded-xl text-sm font-semibold transition-all min-h-[44px] border border-[rgba(255,255,255,0.15)] text-white/80 bg-[rgba(255,255,255,0.05)] hover:bg-[rgba(255,255,255,0.10)] hover:border-[rgba(255,255,255,0.28)] active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed"
        ...
        <div class="relative w-full max-w-md rounded-2xl border border-[var(--sys-border)] bg-[var(--sys-bg-surface)] overflow-hidden z-10">
          ...
          <div class="px-5 pb-5 space-y-3">
            ...
            <div class="flex gap-2">
              ...
              <!-- Kopier-Button -->
              <button
                class="flex-1 py-2.5 rounded-xl text-xs font-medium transition-all min-h-[40px] border active:scale-[0.98]"
