      ...
      <div v-if="open || modal" class="border-t border-[var(--sys-border)]">
        ...
        <div class="flex relative">
          ...
          >
            <!-- Step icon circle -->
            <div
              class="w-8 h-8 rounded-xl flex items-center justify-center transition-all duration-200 relative"
              :class="currentStep === i
                ? 'scale-110 shadow-lg'
                : 'scale-100'"
              :style="currentStep === i
        ...
        <div class="relative min-h-[100px]">
          ...
          <div v-show="currentStep === 0" class="p-5 space-y-3">
            ...
            <!-- Status -->
            <div class="flex items-center gap-3 px-4 py-3 rounded-xl bg-[rgba(255,255,255,0.04)] border border-white/10">
            ...
            <button
              ...
              class="w-full h-12 flex items-center gap-3 px-4 rounded-xl border border-white/15 bg-[rgba(255,255,255,0.04)] text-sm text-white/80 hover:bg-[rgba(255,255,255,0.09)] hover:border-white/25 disabled:opacity-40 active:scale-[0.99] transition-all"
            >
        ...
        <div class="flex items-center justify-between px-5 py-4 border-t border-[var(--sys-border)]">
          <button
            v-if="currentStep > 0"
            class="flex items-center gap-1.5 text-xs font-medium text-[var(--sys-fg-dim)] hover:text-[var(--sys-fg)] transition-colors py-2 px-3 rounded-lg hover:bg-[rgba(255,255,255,0.05)] min-h-[36px]"
            @click="currentStep--"
          >
          ...
          <button
            ...
            class="flex items-center gap-1.5 text-xs font-semibold px-4 py-2 rounded-xl min-h-[36px] transition-all duration-150 active:scale-[0.97]"
          ...
          <button
            v-else
            class="flex items-center gap-1.5 text-xs font-semibold px-4 py-2 rounded-xl min-h-[36px] transition-all duration-150 active:scale-[0.97] bg-[var(--sys-violet)] text-white hover:opacity-90"
