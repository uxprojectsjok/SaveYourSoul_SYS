    ...
    >
      ...
      <div class="flex items-center gap-2">
        <button
          ...
          :disabled="loading"
          class="w-7 h-7 flex items-center justify-center rounded-lg text-[var(--sys-fg-dim)] hover:text-[var(--sys-fg)] hover:bg-[rgba(255,255,255,0.06)] transition-colors"
    ...
    <Transition name="slide-up">
      <div v-if="open || headless" class="border-t border-[var(--sys-border)]">
        ...
        <div class="px-5 pt-4 pb-3">
          ...
          <div class="flex items-center gap-2 rounded-xl bg-[rgba(255,255,255,0.03)] border border-[var(--sys-border)] px-3 py-2.5">
            <p class="flex-1 text-xs font-mono text-[var(--sys-fg-muted)] truncate select-all">{{ ownSoulId || '—' }}</p>
            <button
              class="flex-none w-7 h-7 flex items-center justify-center rounded-lg text-[var(--sys-fg-dim)] hover:text-[var(--sys-fg)] hover:bg-[rgba(255,255,255,0.07)] transition-colors"
          ...
          <p class="text-xs text-[var(--sys-fg-dim)] mt-1.5 leading-relaxed">
        ...
        <div v-if="removedByPeer.length" class="px-5 pb-3 space-y-2">
          ...
          <div
            ...
            :key="n.soul_id"
            class="rounded-xl bg-[rgba(239,68,68,0.06)] border border-[rgba(239,68,68,0.18)] px-4 py-3 flex items-start justify-between gap-3"
          >
            ...
            <button
              class="flex-none text-xs px-2 py-1 rounded border border-[rgba(239,68,68,0.2)] text-red-400 hover:bg-[rgba(239,68,68,0.1)] transition-colors min-h-[28px]"
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2 flex-wrap">
                ...
                <span
                  v-if="!conn.mutual"
                  class="text-xs px-1.5 py-0.5 rounded bg-[rgba(255,255,255,0.05)] text-white/45 border border-[rgba(255,255,255,0.10)]"
                >einseitig</span>
                <!-- Verschlüsselt-Badge -->
                <span
                  v-if="conn.encrypted"
                  class="flex items-center gap-1 text-xs px-1.5 py-0.5 rounded bg-[rgba(255,255,255,0.06)] text-[var(--sys-fg-dim)] border border-[var(--sys-border)]"
            ...
            <button
              class="text-xs px-2 py-1 rounded border border-[rgba(239,68,68,0.2)] text-red-400 hover:bg-[rgba(239,68,68,0.1)] transition-colors min-h-[28px] flex-none"
        ...
        <div class="px-5 pb-5 pt-3 border-t border-[var(--sys-border)]">
          <button
            class="w-full py-3 rounded-xl text-sm font-medium transition-all min-h-[44px] border border-[var(--sys-border)] text-[var(--sys-fg-muted)] bg-[rgba(255,255,255,0.03)] hover:bg-[rgba(255,255,255,0.06)] hover:text-[var(--sys-fg)] active:scale-[0.98]"
      ...
      >
        ...
        <div class="relative w-full max-w-md rounded-2xl border border-[var(--sys-border)] bg-[var(--sys-bg-surface)] overflow-hidden z-10">
          ...
          <div class="px-5 pb-5 space-y-3">
            ...
            <div class="rounded-xl bg-[rgba(255,255,255,0.03)] border border-[var(--sys-border)] px-4 py-3">
              <input
                v-model="newSoulId"
                type="text"
            ...
            <input
              ...
              class="w-full bg-[rgba(255,255,255,0.04)] border border-[var(--sys-border)] rounded-xl px-4 py-3 text-sm text-[var(--sys-fg)] placeholder-[var(--sys-fg-dim)] focus:outline-none focus:border-[rgba(255,255,255,0.30)] transition-colors"
            />
            ...
            <div class="flex flex-wrap gap-2">
              <button
                ...
                :key="p.value"
                class="text-xs px-3 py-1.5 rounded-lg border transition-all min-h-[32px]"
