      ...
      <div v-if="open || headless" class="px-5 pb-5 space-y-4 border-t border-[var(--sys-border)]">
        ...
        <template v-if="enabled">
          ...
          <div>
            ...
            <p class="text-xs text-[var(--sys-fg-dim)] mb-2 opacity-60">Gilt für Public Vault — was externe Dienste und verbundene Souls sehen dürfen.</p>
            <div class="space-y-2">
              <label
          ...
          <button
            @click="onSave"
            :disabled="isSaving"
            class="w-full py-2.5 rounded-xl border border-[rgba(255,255,255,0.18)] text-white/75 text-xs hover:bg-[rgba(255,255,255,0.06)] hover:border-white/28 transition-all disabled:opacity-40 min-h-[40px] active:scale-[0.97]"
