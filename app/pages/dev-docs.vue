      ...
      <main class="font-content flex-1 min-w-0 px-6 md:px-10 lg:px-16 py-10 md:py-12">
        ...
        <section id="quickstart" class="doc-section mb-16 scroll-mt-20">
          ...
          <div class="doc-warning-box mb-6">
            ...
            <p class="text-xs text-[var(--sys-fg-dim)]">The reference implementation runs as a closed application by UX-Projects YOUR_NAME. This guide assumes access to a running SYS instance. For self-hosting see <code class="doc-code">docs/PRODUCTION_SETUP.md</code>.</p>
          </div>
...
const mcpTools = [
  ...
  { name: 'network_peer_get', perm: 'soul', desc: 'Read shared content from a connected peer\'s Public Vault' },
  ...
  { name: 'twilio_call_config', perm: 'soul', desc: 'Configure outbound Twilio call with voice agent settings' },
]
