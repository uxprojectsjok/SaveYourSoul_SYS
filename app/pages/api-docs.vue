      ...
      <header class="docs-nav">
        <div class="docs-nav-inner">
          <div class="docs-lockup">
            <img src="/logo.png" alt="SYS" class="docs-logo" />
        ...
        <main class="font-content flex-1 min-w-0 px-6 md:px-10 lg:px-16 py-10 md:py-12">
          ...
          <section :id="'create-soul'" class="doc-section mb-16 scroll-mt-20">
            ...
            <div class="doc-warning-box my-6">
              ...
              <p class="text-xs text-[var(--sys-fg-dim)] leading-relaxed">SaveYourSoul ist eine geschlossene Anwendung von UX-Projects YOUR_NAME. Die Erstellung neuer Souls ist auf interne Nutzerinnen und Nutzer beschränkt. Kein öffentlicher Betrieb.</p>
            </div>
          ...
          <section :id="'mcp-protocol'" class="doc-section mb-16 scroll-mt-20">
            ...
            <div class="doc-info-box my-4">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1 text-xs text-[var(--sys-fg-dim)] font-mono">
                ...
                <span>network_list / network_peer_get</span><span class="text-white/35">Soul-Network-Verbindungen + Dateien aus Public Vault von Peers lesen</span>
...
const endpoints = [
  ...
  },
  {
    ...
    desc: 'Streamt eine Datei aus dem Public Vault eines verbundenen Peers als rohe Binärdaten mit korrektem Content-Type. Wird intern von network_peer_get genutzt, kann aber auch direkt aufgerufen werden. Parameter: soul_id, file, token.',
    response: null
  },
  {
...
.docs-back { font-family: var(--mono); font-size: 10px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--fg-3); text-decoration: none; transition: color 0.15s; white-space: nowrap; }
