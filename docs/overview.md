...
│  pol_access_token — paid agent, on-chain     │
│  service-token    — scoped external access   │
│  BIP39-auth       — ciphertext via words     │
├─────────────────────────────────────────────┤
│  AI Interface Layer                          │
...
| ERC-8004 | Agent identity standard (NFT per agent, Polygon). SYS is the complementary user-identity layer — agents discover and pay human souls via the Agent Marketplace. |
